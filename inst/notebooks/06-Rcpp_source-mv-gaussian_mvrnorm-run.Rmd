...
Loading code from a C++ file:

```{r warning=FALSE}
library(Rcpp)
<<<<<<< HEAD:inst/notebooks/mv-gaussian_mvrnorm-run.Rmd
setwd(src)
...
mu <- c(10, 5, -3)
>>>>>>> release/v0.03:inst/notebooks/06-Rcpp_source-mv-gaussian_mvrnorm-run.Rmd
mvrnormArma2 <- mvrnormArmaCpp(1e4, mu, sigma)
head(mvrnormArma2)
